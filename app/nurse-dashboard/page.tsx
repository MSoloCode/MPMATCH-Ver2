      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            The full Nurse dashboard with patient care workflows, vitals tracking, and clinical observations is being developed.
          </p>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="font-semibold text-gray-900 mb-2">Patient Vitals</h3>
            <p className="text-sm text-gray-600">Monitor and record patient vital signs and observations.</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="font-semibold text-gray-900 mb-2">Care Plans</h3>
            <p className="text-sm text-gray-600">View and execute patient care plans and interventions.</p>
          </div>
        </div>
      </div>
    </div>
