    ...
    <main className="min-h-screen bg-gradient-to-b from-primary to-primary-light">
          ...
          <div className="bg-red-50 border-2 border-red-300 rounded-lg p-8">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-black font-semibold">🩸 Severe vaginal bleeding</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-red-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black font-semibold">😵 Severe headache or blurred vision</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-red-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black font-semibold">🤢 Severe abdominal or chest pain</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-red-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black font-semibold">🔥 High fever ({'>'}38.5°C)</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-red-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black font-semibold">💧 Sudden loss of fluid or leaking</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-red-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black font-semibold">🤕 Loss of consciousness or seizures</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-red-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black font-semibold">😤 Severe difficulty breathing</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-red-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black font-semibold">❌ Baby not moving</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-8">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-black">Mild vaginal bleeding or spotting</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-yellow-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black">Mild headache or dizziness</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-yellow-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black">Mild abdominal discomfort</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-yellow-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black">Persistent nausea or vomiting</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-yellow-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black">Low-grade fever (37.5-38.5°C)</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-yellow-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black">Reduced fetal movement</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-yellow-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black">Unusual discharge</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-yellow-600 flex-shrink-0 mt-1" size={20} />
                <span className="text-black">Swelling of face or limbs</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 bg-white rounded-lg">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Via App */}
          <div className="p-6 border-t-4 border-accent rounded-lg bg-white">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* Via SMS */}
          <div className="p-6 border-t-4 border-secondary rounded-lg bg-white">
            <div className="flex items-center gap-3 mb-4">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 bg-red-50 rounded-lg">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-black font-semibold mb-2">Emergency Services</p>
            <p className="text-sm text-black">For life-threatening emergencies - call immediately</p>
          </div>

          <div className="text-center p-6 bg-white rounded-lg shadow-md">
            <p className="text-2xl font-bold text-accent mb-2">15555</p>
            <p className="text-black font-semibold mb-2">MPMATCH SMS</p>
            <p className="text-sm text-black">Text SOS for emergency alert</p>
          </div>

          <div className="text-center p-6 bg-white rounded-lg shadow-md">
            <p className="text-2xl font-bold text-secondary mb-2">*155*55#</p>
            <p className="text-black font-semibold mb-2">MPMATCH USSD</p>
            <p className="text-sm text-black">Dial for emergency menu</p>
          </div>
        </div>
      </section>
