...
export default function CHWRegisterPage() {
  ...
  const [selectedDistrictFacilities, setSelectedDistrictFacilities] = useState<
  ...
  useEffect(() => {
    if (formData.districtId) {
      const selected = districts.find((d) => d.id === parseInt(formData.districtId, 10));
      setSelectedDistrictFacilities(selected?.facilities || []);
  ...
  const validateStep1 = (): boolean => {
    ...
    if (!formData.facilityId) {
      newErrors.facilityId = 'Healthcare facility is required';
    }
  ...
  const handleRegistration = async () => {
    ...
    try {
      const response = await fetch('/api/chws/register', {
        method: 'POST',
      ...
      <div className="min-h-screen bg-gradient-to-b from-primary-50 to-neutral-50 py-12 px-4">
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-neutral-200">
            ...
            <p className="text-neutral-600 mb-6">Please provide your professional information</p>
            ...
            <div className="mb-6 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-900">
                <strong>Role:</strong> Community Health Worker (CHW)
              </p>
            </div>
            ...
            <form className="space-y-5">
              ...
              <SelectDropdown
                ...
                placeholder={
                  selectedDistrictFacilities.length === 0
                    ? 'Select a district first...'
                    : 'Select your facility...'
                }
                options={selectedDistrictFacilities.map((f) => ({
                  value: f.id,
                  label: `${f.name} (${f.type})`,
                }))}
                ...
                onChange={(e) => {
                  ...
                  if (errors.facilityId) setErrors({ ...errors, facilityId: undefined });
                }}
                error={errors.facilityId}
                disabled={selectedDistrictFacilities.length === 0}
                required
              />
            </form>
      ...
      <div className="min-h-screen bg-gradient-to-b from-primary-50 to-neutral-50 py-12 px-4 flex items-center justify-center">
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-neutral-200 text-center">
            ...
            <p className="text-neutral-600 mb-6">
              Welcome to MPMATCH, {formData.fullName.split(' ')[0]}! Your CHW account has been
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-left">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                ...
                <li>✓ Redirecting to your CHW dashboard in 2 seconds...</li>
                <li>✓ You can now manage mothers and coordinate care</li>
              </ul>
            </div>

            <p className="text-xs text-neutral-600">Redirecting to dashboard...</p>
          </div>
        </div>
      </div>
    );
