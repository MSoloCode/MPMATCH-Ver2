        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-accent">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-neutral">Data encrypted in transit (moving between devices and servers)</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-accent flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Data encrypted at rest (stored on secure servers)</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-accent flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Only authorized personnel can access encrypted data</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-accent flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Regular security audits and vulnerability testing</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-secondary">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-neutral">Mothers can only see their own health data</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-secondary flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">CHWs see data for mothers they're assigned to</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-secondary flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Healthcare staff see only relevant clinical information</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-secondary flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Administrators have limited access for system management only</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-accent">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <CheckCircle className="text-accent flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">You can view all your personal and health data anytime</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-accent flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Request corrections or updates to your information</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-accent flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Request deletion of your account and data</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-accent flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Opt out of non-emergency communications</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-accent flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">We never sell your data to third parties</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-secondary">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <CheckCircle className="text-secondary flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Servers in geographically distributed locations</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-secondary flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Automated daily backups and disaster recovery</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-secondary flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">24/7 monitoring and intrusion detection</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-secondary flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Regular security patches and updates</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="text-secondary flex-shrink-0 mt-1" size={18} />
                <span className="text-neutral">Compliance with healthcare data standards</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 bg-white rounded-lg">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-6 border border-accent border-opacity-20 rounded-lg">
            ...
            <ul className="space-y-3 text-neutral text-opacity-70">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg p-6 shadow-md">
            ...
            <ul className="space-y-3 text-neutral text-opacity-70 text-sm">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 bg-white rounded-lg">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="text-center p-6">
            ...
            <p className="text-neutral text-opacity-70 mb-4">
            ...
            <div className="bg-accent bg-opacity-10 p-4 rounded-lg">
              ...
              <p className="text-neutral">security@mpmatch.ug</p>
              <p className="text-sm font-semibold text-primary mt-3">Phone:</p>
              <p className="text-neutral">+256-700-MPMATCH</p>
            </div>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <div className="bg-secondary bg-opacity-10 p-4 rounded-lg">
              ...
              <p className="text-neutral text-sm">security-report@mpmatch.ug</p>
              <p className="text-neutral text-xs mt-2">We follow responsible disclosure practices and reward security researchers.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <div className="text-center p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-sm text-neutral text-opacity-70">All data encrypted with industry standards</p>
          </div>
          
          <div className="text-center p-6 bg-white rounded-lg shadow-md">
            <Shield className="text-secondary mx-auto mb-3" size={40} />
            <h4 className="font-bold text-primary mb-2">Secure</h4>
            <p className="text-sm text-neutral text-opacity-70">24/7 monitoring and threat detection</p>
          </div>
          
          <div className="text-center p-6 bg-white rounded-lg shadow-md">
            <Eye className="text-accent mx-auto mb-3" size={40} />
            <h4 className="font-bold text-primary mb-2">Transparent</h4>
            <p className="text-sm text-neutral text-opacity-70">Clear privacy policies and data usage</p>
          </div>
          
          <div className="text-center p-6 bg-white rounded-lg shadow-md">
            <Key className="text-secondary mx-auto mb-3" size={40} />
            <h4 className="font-bold text-primary mb-2">Controlled</h4>
            <p className="text-sm text-neutral text-opacity-70">You control who sees your data</p>
          </div>
        </div>
      </section>
